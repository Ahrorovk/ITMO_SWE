...
public class DefaultCommand extends Command {
  private static interface ArgExecuter {
    public boolean execute(String s, Console cons, TCPManager tcpm);
  }

  private static interface AskExecuter {
    public Object execute(Console cons);
  }
  ...
  private static boolean argIndex(String s, Console cons, TCPManager tcpm) {
    ...
    try {
      ...
      cons.println("index wasn`t found");
      return false;
    }
    if (index < 0) {
